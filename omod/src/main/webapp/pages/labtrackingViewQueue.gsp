                  ...
                  <tr ng-repeat="a in testOrderQueue" >
                     ...
                     <td nowrap class="text-center small date-link">
                        <a role="button" ng-class="{ 'no-link': !canEdit() }" ng-click="canEdit() && handleDetails(a, 'specimen')">
                           ...
                           <span ng-if="a.processedDate.value!=null">{{a.processedDate.value | date : dateFormat }}
                              <i class="glyphicon glyphicon-edit" aria-hidden="true"></i>
                           </span>
                        </a>
                     </td>
                     <td nowrap class="text-center small date-link"><span role="button" ng-show="a.files.length > 0" ng-click="handleDetails(a, 'readonly')" title="Download"><i class="glyphicon glyphicon-download" aria-hidden="true"></i></span>
